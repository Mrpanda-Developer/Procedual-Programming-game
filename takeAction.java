...
public class takeAction {
    public static int Visitor(String action, int currentState, Scanner scanner) {
        ...
        // --- STATE 1: Hal ---
            ...
            return 1; // terug naar hallway na race
        }
